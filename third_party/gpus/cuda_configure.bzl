...
def error_gpu_disabled():
  fail("ERROR: Building with --config=cuda but bazel_cuda is not configured " +
...
# Note(bazel_cudapku): Uncomment the following rule iff "--experimental_repo_remote_exec"
