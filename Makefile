...
mnist_planes_experiment:
	@echo "Running the MNIST Planes experiment"
	bazel run experiments:mnist_planes

cifar10_planes_experiment:
	@echo "Running the CIFAR-10 Planes experiment"
	bazel run experiments:cifar10_planes
